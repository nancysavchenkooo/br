...
-----------------------------------------------------""")
    ...
    def ua_asu(self):
        ...
        return (f"Dalvik/2.1.0 (Linux; U; Android {vers}; Redmi Note 8 Pro MIUI/V12.0.1.0.QGGEUXM) [FBAN/FB4A;FBAV/{xnxx};FBBV/9186100;FBDM/"+"{density=2.75,width=1080,height=2179};FBLC/id_ID;FBCR/XL;FBMF/Xiaomi;FBBD/POCO;FBPN/com.facebook.katana;FBDV/M2102K1C;FBSV/10;FBBK/0;FBOP/1;FBCA/armeabi-v7a:armeabi;][ip:213.32.4.102]")
